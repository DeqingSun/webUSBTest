...
BlocklyStorage.link = function(opt_workspace) {
  ...
  BlocklyStorage.makeRequest_('https://blocklystorage.appspot.com/storage', 'xml', data, workspace);
};
...
BlocklyStorage.retrieveXml = function(key, opt_workspace) {
  var workspace = opt_workspace || Blockly.getMainWorkspace();
  BlocklyStorage.makeRequest_('https://blocklystorage.appspot.com/storage', 'key', key, workspace);
};
